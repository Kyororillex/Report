...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[scale=0.4]{通常.png}}
  \caption{}
\end{figure}

\subsection{削除に用いられたAPI}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[scale=0.4]{pic1.png}}
  \caption{}
\end{figure}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[scale=0.6]{TCPログ.png}}
  \caption{}
\end{figure}
...
(1) マイクロソフト\\
\url{https://docs.microsoft.com/ja-jp/windows-hardware/drivers/ddi/ntddk/ns-ntddk-_file_disposition_information_ex}
