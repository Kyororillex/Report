...
パスワードではなく、SQL文として認識されるために起こるのが想定される。
...
\begin{figure}[h]
  ...
  \begin{minipage}[b]{0.45\linewidth}
  \begin{center}
    \includegraphics[keepaspectratio,scale=0.3]{pic14.png}
    \end{center}
    \caption{}
  \end{minipage}
  \begin{minipage}[b]{0.45\linewidth}
  \begin{center}
    \includegraphics[keepaspectratio,scale=0.3]{pic15.png}
    \end{center}
    \caption{}
  \end{minipage}
\end{figure}
...
この演習では、口座残高確認後のurlを見ると「\url{http://appgoat.cysec-lab.org/Users/is0585xf/Web/Scenario1222/VulSoft/bank.php?page=3&account_id=1000005}」
...
\begin{figure}[h]
  ...
  \begin{minipage}[b]{0.45\linewidth}
  \begin{center}
    \includegraphics[keepaspectratio,scale=0.3]{pic16.png}
    \end{center}
    \caption{}
  \end{minipage}
  \begin{minipage}[b]{0.45\linewidth}
  \begin{center}
    \includegraphics[keepaspectratio,scale=0.3]{pic17.png}
    \end{center}
    \caption{}
  \end{minipage}
\end{figure}
